...
const nav = [
  ...
  {
    text: 'Changelog',
    link: 'https://github.com/stacksjs/dnsx/blob/main/CHANGELOG.md',
  },
...
export default withPwa(
  defineConfig({
    ...
    head: [
      ...
      ['meta', {
        name: 'tags',
        content: 'dns, dnsx, dig, dog, cli, library, bun, stacks, typescript, javascript, node, deno',
      }],
    ...
    themeConfig: {
      ...
      editLink: {
        pattern: 'https://github.com/stacksjs/dnsx/edit/main/docs/docs/:path',
      ...
      socialLinks: [
        ...
        { icon: 'github', link: 'https://github.com/stacksjs/dnsx' },
